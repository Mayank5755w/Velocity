        ...
        >
          <div className="relative aspect-[4/3] overflow-hidden">
            <motion.img
              ...
              //greyscale ui className="w-full h-full object-cover grayscale brightness-75 group-hover:grayscale-0 group-hover:brightness-100 transition-all duration-700"
