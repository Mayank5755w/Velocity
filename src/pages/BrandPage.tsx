    ...
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-center px-6">
          ...
          <h1 className="text-4xl font-black italic uppercase mb-8">Brand Not Found</h1>
      ...
      <div className="flex flex-1 min-w-0">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          ...
          <section className="px-4 md:px-10 pt-10 pb-8">
            <p className="text-[10px] uppercase tracking-[0.5em] text-zinc-600 mb-3">Brand Collection</p>
                ...
                {wallpapers.map(car => (
                  <Link key={car.id} to={`/brand/${car.brand.toLowerCase()}/${car.slug}`}
                    ...
                    <motion.div whileHover={{ y: -2 }} transition={{ duration: 0.2 }}>
                      ...
                      <div className="p-4">
                        <p className="text-[9px] font-black uppercase tracking-[0.3em] text-zinc-500 mb-1">{car.category}</p>
        ...
        <aside className="w-56 hidden xl:flex flex-col py-10 px-6 border-l border-zinc-900 bg-[#050505] shrink-0">
          <div className="space-y-10">
            <div>
              <p className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.3em] mb-4">THIS BRAND</p>
            ...
            <div>
              <button onClick={() => setBrandsOpen(prev => !prev)} className="w-full flex items-center justify-between group/brands">
                <p className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.3em] group-hover/brands:text-white/60 transition-colors">OTHER BRANDS</p>
