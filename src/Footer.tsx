  ...
  return (
    <footer className="bg-[#050505] border-t border-zinc-900 w-full">
      ...
      <div className="px-6 md:px-12 xl:px-16 pt-12 pb-8">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-[11px] font-medium leading-relaxed text-zinc-300 tracking-wide max-w-[220px] mb-6">
          ...
          {/* ── COL 2: Navigation ── */}
          <div>
            <p className="text-[9px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-4">Navigate</p>
            <ul className="space-y-2.5">
              {NAV.map(({ label, to }) => (
                <li key={label}>
                  <Link to={to}
                    className="text-[12px] font-bold uppercase tracking-widest text-zinc-300 hover:text-white transition-colors duration-200 flex items-center gap-2 group">
                    <span className="w-4 h-px bg-zinc-800 group-hover:bg-white/50 group-hover:w-6 transition-all duration-300 shrink-0" />
                    {label}
                  </Link>
                </li>
              ))}
          ...
          {/* ── COL 3: Categories ── */}
          <div>
            <p className="text-[9px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-4">Categories</p>
            <ul className="space-y-2.5">
          ...
          <div className="border-l border-zinc-900 pl-6">
            <p className="text-[9px] font-black uppercase tracking-[0.4em] text-zinc-400 mb-4">Experience</p>
            <h3 className="text-2xl font-black italic uppercase leading-none tracking-tight mb-4 text-white">
              BUILT<br />FOR<br />ENTHUSIASTS
            </h3>
            <p className="text-[11px] leading-relaxed text-zinc-300 max-w-[200px]">
          ...
          <div className="flex items-center gap-6">
            {LEGAL.map(({ label, to }) => (
              <Link key={label} to={to}
                className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400 hover:text-white transition-colors duration-200">
                {label}
              </Link>
            ))}
          </div>
      ...
      <div className="py-2 flex items-center justify-center border-t border-zinc-900/50">
        <p className="text-[8px] font-black uppercase tracking-[0.6em] text-white/[0.15] select-none">
